...
=/  txs
  ...
  =^  adopt-commit-out   walt  (adopt:btc:walt ship)
  =^  spawn-commit-out   walt  (spawn:btc:walt [spk=adopt-commit-out pos=`0 off=0 tej=0])
  =^  spawn-commit-tx    walt  (spend:btc:walt spawn-commit-out)
  =^  adopt-commit-tx    walt  (spend:btc:walt adopt-commit-out)
  ::
  :~  spawn-commit-tx
      adopt-commit-tx
  ==
